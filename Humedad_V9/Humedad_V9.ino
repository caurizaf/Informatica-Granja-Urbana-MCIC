...
SoftwareSerial serialWifi(7,6);//Declaramos el pin 7 Tx y 6 Rx
SoftwareSerial serialgps(2,3);//Declaramos el pin 3 Tx y 32 Rx
...
String set_humsuel ()
{
    ...
    if (humedad_A0 < 400 || humedad_A1 < 400 )
      {
        msg_hs += set_offba();
      }
    else
